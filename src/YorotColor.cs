...
namespace Yorot
{
    public class YorotColor
    {
        /// <summary>
        /// Creates a new <see cref="YorotColor"/>.
        /// </summary>
        /// <param name="a">Alpha Channel</param>
        /// <param name="r">Red Channel</param>
        /// <param name="g">Green Channel</param>
        /// <param name="b">Blue Channel</param>
        public YorotColor(byte a, byte r, byte g, byte b)
        {
            A = a;
            R = r;
            G = g;
        ...
        /// <param name="g">Green Channel</param>
        /// <param name="b">Blue Channel</param>
        public YorotColor(byte r, byte g, byte b) : this(byte.MaxValue, r, g, b)
        {
        }

        /// <summary>
        /// Create a new <see cref="YorotColor"/>.
        /// </summary>
        ...
        public YorotColor(byte all, bool includesAlpha = false) : this(includesAlpha ? all : byte.MaxValue, all, all, all)
        {
        }
        ...
        /// <param name="all">Value of all channels.</param>
        /// <param name="includesAlpha">Determines if the value of <paramref name="all"/> should include the <see cref="A"/> channel or not.</param>
        public YorotColor(int all, bool includesAlpha = false) : this(includesAlpha ? all : 255, all, all, all)
        {
        }
        ...
        /// <param name="g">Green Channel</param>
        /// <param name="b">Blue Channel</param>
        public YorotColor(int r, int g, int b) : this(255, r, g, b)
        {
        }
        ...
        /// <param name="g">Green Channel</param>
        /// <param name="b">Blue Channel</param>
        public YorotColor(int a, int r, int g, int b)
        {
            A = (byte)a;
            R = (byte)r;
            G = (byte)g;
        ...
        /// </summary>
        /// <param name="value">Calue to increase/decrease.</param>
        /// <param name="shiftAlpha">Determines if the <see cref="A"/> should be shifted too.</param>
        /// <returns><see cref="YorotColor"/></returns>
        public YorotColor ShiftBrightness(int value, bool shiftAlpha = false)
        {
            var color = new YorotColor(
        ...
        public YorotColor AutoWhiteBlack => IsBright ? YorotColor.Black : YorotColor.White;
        ...
        public YorotColor WhiteOrBlack => IsBright ? White : Black;
        ...
        public YorotColor ReverseColor(bool reverseAlpha) => new YorotColor(reverseAlpha ? (255 - A) : A,
                                  255 - R,
                                  255 - G,
                                  255 - B);
        ...
        public static YorotColor RandomColor(int Transparency = 255, bool RandomTransparency = false, int Seed = 172703)
        {
            ...
            int g = rand.Next(max);
            int b = rand.Next(max);
            return new YorotColor(a, r, g, b);
        }

        #region Colors

        public static YorotColor White => new YorotColor(255, 255, 255, 255);
        public static YorotColor Gray => new YorotColor(255, 128, 128, 128);
        public static YorotColor Black => new YorotColor(255, 0, 0, 0);
        public static YorotColor Transparent => new YorotColor(0, 0, 0, 0);
        public static YorotColor Red => new YorotColor(255, 255, 0, 0);
        public static YorotColor Green => new YorotColor(255, 0, 255, 0);
        public static YorotColor Blue => new YorotColor(255, 0, 0, 255);
